...
export function Footer(parentPage = 'Home') {
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li><a
                href='#' onClick={() => scrollToSection('features')} className="hover:text-primary transition-colors">{t('features')}</a></li>
              <li><a href='#' onClick={() => scrollToSection('screenshots')} className="hover:text-primary transition-colors">{t('screenshots')}</a></li>
              <li><a href='#' onClick={() => scrollToSection('download')} className="hover:text-primary transition-colors">{t('download')}</a></li>
              <li><a href='#' onClick={() => scrollToSection('contact')} className="hover:text-primary transition-colors">{t('contact')}</a></li>
            </ul>
          </div>
